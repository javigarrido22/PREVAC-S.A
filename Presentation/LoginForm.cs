    ...
    public partial class LoginForm : Form
    {
        ...
        {//Iniciar sesión
            ...
            if (userModel != null)//Si el inicio de sesión fue exitosa.
            {
                ...
                if (ActiveUser.Position == Positions.Administrador || ActiveUser.Position == Positions.Administrador
                    || ActiveUser.Position == Positions.Profesional || ActiveUser.Position == Positions.Administrador)
                {
                ...
                else if(ActiveUser.Position == Positions.Cliente)
                {
                    mainForm = new ChildForms.FormClientes();
                }
